...
class Unpacker:
	"""Replacement for xdrlib.Unpacker which was removed in Python 3.13"""
	...
	def unpack_string(self):
		...
		self.pos += padded_length
		return result

	def unpack_farray(self, count, unpack_func):
		return [unpack_func() for _ in range(count)]
